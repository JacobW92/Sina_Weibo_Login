...
@interface NSString (ABCD)
@end
@implementation NSString (ABCD)
...
+ (NSString *)encryptString:(NSString *)str publicKey:(NSString *)pubKey{
    ...
    NSString *ret = [[NSString alloc] getHEX:data];
    //    NSString *ret = base64_encode_data(data);
    //    char *a = [data bytes];
    //
    //    NSString *ret = [[NSString alloc] initWithCString:a encoding:NSASCIIStringEncoding];
    //
    return ret;
}
